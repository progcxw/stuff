...
func Int64(key string) (ret int64, err error) {
	value, err := getData(key)
	if err != nil {
		err = fmt.Errorf("configer get key: %v fail, err: %w", key, err)
		log.Error(err)
...
func Bool(key string) (ret bool, err error) {
	value, err := getData(key)
	if err != nil {
		err = fmt.Errorf("configer get key: %v fail, err: %w", key, err)
		log.Error(err)
...
func Float64(key string) (ret float64, err error) {
	value, err := getData(key)
	if err != nil {
		err = fmt.Errorf("configer get key: %v fail, err: %w", key, err)
		log.Error(err)
...
func DefaultInt64(key string, defaultValue int64) (ret int64) {
	ret, err := Int64(key)
	if err != nil {
		ret = defaultValue
	}
...
func DefaultBool(key string, defaultValue bool) (ret bool) {
	ret, err := Bool(key)
	if err != nil {
		ret = defaultValue
	}
...
func DefaultFloat64(key string, defaultValue float64) (ret float64) {
	ret, err := Float64(key)
	if err != nil {
		ret = defaultValue
	}
...
func MustInt(key string) (ret int) {
	ret, err := Int(key)
	if err != nil {
		panic(err)
	}
...
func MustInt64(key string) (ret int64) {
	ret, err := Int64(key)
	if err != nil {
		panic(err)
	}
...
func MustBool(key string) (ret bool) {
	ret, err := Bool(key)
	if err != nil {
		panic(err)
	}
...
func MustFloat64(key string) (ret float64) {
	ret, err := Float64(key)
	if err != nil {
		panic(err)
	}
